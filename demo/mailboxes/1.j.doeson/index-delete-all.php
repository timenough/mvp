...
try {
    ...
    global $_mail_technology_instance_1;
    global $_mail_technology_instance_4;
    ...
    $_mail_technology_inbox_emails =
        $_mail_technology_instance_4 ->
            getEmails (
                $_ENV['MAIL_PROPRIETARY_TECHNOLOGY_EMP_1_HASH'],
                null,
                100,
                null,
                null,
    ...
    if (
        isset (
            $_mail_technology_inbox_emails[0]
        )
    ) {

        foreach (
            $_mail_technology_inbox_emails as $_one => $_email
        ) {
            ...
            if (
                $_email_timestamp <= $_one_hour_ago
            ) {

                $_mail_technology_instance_1 ->
                    deleteEmail (
                        $_email_id
                    );
    ...
    header (
        'Location: ' . SERVER_BASE_URL . '/demo/mailboxes/1.j.doeson'
    );
