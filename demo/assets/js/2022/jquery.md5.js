...
class replyFreeHtmlEmbed extends BlockEmbed {
static create(value) {
...
// blotName
replyFreeHtmlEmbed.blotName = 'replyFreeHtmlEmbed';
//The class name will be used to match the blot name
replyFreeHtmlEmbed.className = 'embed-innerApp';
//Label type customization
replyFreeHtmlEmbed.tagName = 'div';
Quill.register(replyFreeHtmlEmbed, true);
