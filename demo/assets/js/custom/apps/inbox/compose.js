    ...
    const e = (e) => {
        ...
        t = (e) => {
            ...
            t.addEventListener("click", async () => {
                ...
                if(
                    (
                        subject.length < minimalSubjectLength &&
                    ...
                    var errorMessage =
                    `The subject of your e-mail is too short or empty. ${minimalSubjectLength} characters minimum required.`;

                    if(
                        body.length < minimalContentLength &&
                        botsThatDontNeedSubjectAndBodyInvolved.length === 0
                    )errorMessage =
                    `The body of your email is too short or empty. ${minimalContentLength} characters minimum required.`;
                 ...
                 * */
                    ...
                    .then(
                        async (
                            ...
                            const subjectToxicityScore =
                            perspecttiveApiRequestScore(
                                queryData1
                            );

                            if(
                                subjectToxicityScore >= perspecttiveApiToxicityMax
                            ){

                                const currentScore =
                                    (subjectToxicityScore*100)
                                    .toFixed(2);

                                return Promise
                                .reject(
                                    {
                                        responseText: '{"error":{"message":"This <u>email subject</u>\'s level of toxicity is <b>' + currentScore + '%</b>, exceeding the maximum acceptable level of ' + maxScore + '%."}}'
                                    }
                                );
                                ...
                                .then(
                                    async (
                                        ...
                                        if(
                                            ...
                                            .reject(
                                                {
                                                    responseText: '{"error":{"message":"This <u>email body</u>\'s level of toxicity is <b>' + currentScore + '%</b>, exceeding the maximum acceptable level of ' + maxScore + '%."}}'
                                                }
                                            );
                                        }
                                        else{
                    ...
                    .catch(
                        (
                            ...
                            .fire(
                                {
                                    html: `<p>We use <a href="https://bit.ly/33gYfZW" target="_blank" class="spe">Perspective API</a> to verify the <b>toxicity</b> of your email subject and body, to prevent <b>insults</b>, <b>harassment</b>, and <b>hate</b> speech through this free online demo of timeNough.
                                        <br/>
                                        <br/>
        ...
        n = (e) => {
            new Quill("#kt_inbox_form_editor", { modules: { toolbar: [[{ header: [1, 2, !1] }], ["bold", "italic", "underline"], ["image", "code-block"]] }, placeholder: "Type your text here...", theme: "snow" });
